...
function calculateSTI(array){
  ...
  newArray[0] = array[i][0]; //added the [0] indicating the array index, to fix an issue where the first array's "name" was being repeated

  var employeeNumber = array[i][1];//added [i] to allow the 'for' loop to correctly loop through 'array' grabbing values from the correct index
